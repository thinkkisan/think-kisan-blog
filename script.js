/*
========================================
AgriSense Blog Post JavaScript
========================================
...
function createGalleryItem(id, src, caption = "") {
  ...
  item.innerHTML = `
    <img src="${src}" alt="${caption || "Uploaded image"}" loading="lazy">
    <div class="gallery-caption">
      <textarea placeholder="Add caption..." aria-label="Image caption">${caption}</textarea>
    </div>
...
function handleFiles(files) {
  // Remove placeholder items on first upload
  const placeholders = imagePreviewGrid.querySelectorAll(".placeholder-item")
  if (placeholders.length > 0 && files.length > 0) {
...
console.log("[v0] AgriSense blog post initialized successfully")
console.log("[v0] Features loaded: image upload, copy summary, theme toggle, print/export")
